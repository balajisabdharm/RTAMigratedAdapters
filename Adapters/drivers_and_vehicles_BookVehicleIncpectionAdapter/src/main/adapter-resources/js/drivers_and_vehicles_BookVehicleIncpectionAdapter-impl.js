...
function buildBody(parameters, isStatic) {
	var request = "";
MFP.Logger.info("buildBody parameters"+parameters);
	if (isStatic == true) {
...
function invokeWebServiceString(request, isEncryptResponse, encryptionPassword) {
	request='<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:sch="http://www.rta.ae/ActiveMatrix/ESB/AppointmentService/XMLSchema/Schema.xsd"><soapenv:Header><wsse:Security soapenv:mustUnderstand="0" xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" xmlns="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd" xmlns:sch="http://schemas.xmlsoap.org/soap/envelope/"><wsse:UsernameToken><wsse:Username>test</wsse:Username><wsse:Password>test</wsse:Password></wsse:UsernameToken></wsse:Security></soapenv:Header><soapenv:Body><sch:getAvailableAppointmentCentersRequest/></soapenv:Body></soapenv:Envelope>';
