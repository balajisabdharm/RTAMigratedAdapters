package com.rta.java.util.url.signing;
...
public class UrlSigner {
  ...
  public static String signURL(String inputURL, String key) throws IOException, InvalidKeyException, NoSuchAlgorithmException, URISyntaxException {
